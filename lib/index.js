...
class Kroncache {
    ...
    connect() {
        return new Promise((resolve, reject) => {
            var _a, _b;
            const port = (_a = this.config) === null || _a === void 0 ? void 0 : _a.port;
            const host = ((_b = this.config) === null || _b === void 0 ? void 0 : _b.host) || 'localhost';
            const endpoint = port ? `ws://${host}:${port}` : `ws://${host}`;
            const ws = (__classPrivateFieldSet(this, _Kroncache_ws, new WebSocket(endpoint), "f"));
