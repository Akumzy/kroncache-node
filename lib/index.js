...
var _Kroncache_ws, _Kroncache_bus;
const ms = require("ms");
...
class Kroncache {
    ...
    connect() {
        return new Promise((resolve, reject) => {
            ...
            const ws = (__classPrivateFieldSet(this, _Kroncache_ws, new WebSocket(`ws://localhost:${port}`), "f"));
...
_Kroncache_ws = new WeakMap(), _Kroncache_bus = new WeakMap();
